...
public class MusicController {
    ...
    public ResponseEntity addSongToPlaylist(
        ...
        try{
            ...
            return ResponseEntity.status(HttpStatus.BAD_REQUEST_400).body(String.format("Song %s (%s) is already in the playlist", adse.getTrack().getId(), adse.getTrack().getName()));
            ...
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR_500).body("spotify returned error code "  + se.getLocalizedMessage());
        } catch (Exception e){
